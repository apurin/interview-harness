...
description: Create rich interactive interviews for users as sharable HTML files. A major-pinned CDN helper library takes care of layout, styling, interview state, output, cards, syntax highlighting, iframe previews, and option comments.
---
